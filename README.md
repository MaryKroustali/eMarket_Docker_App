...
Ο χρήστης καλείται να δώσει το email του, ώστε να ελεγθεί αν έχει ιστρικό ή εάν είναι κενό `if "orderHistory" in user:`. Αν ο χρήστης έχει ιστορικό του εκτυπώνεται αν όχι 
εμφανίζεται αντίστοιχο μήνυμα.

Για την υλοποίηση του entrypoint αρχικά εμφανίζεται το ιστορικό για την παραγγελία του χρήστη στο προηγούμενο entrypoint, ενώ ο ίδιος χρήστης πραγματοποιεί άλλη μία αγορά, η 
οποία προστίθεται στο ιστορικό του.

<img src="screenshots/history1">
<img src="screenshots/history1">
